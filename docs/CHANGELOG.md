...
- Usunięto problemy wykazane w raporcie Sprint 2.4: brak podstawowego fallbacku offline, brak rejestracji service workera oraz drobne niespójności CSS/accessibility.
- Build produkcyjny przechodzi po poprawkach.

## BG Apiary v2.6 - Sprint 2 Final Release

- Finalne wydanie Sprintu 2.
- Ujednolicono wersję aplikacji i dokumentację.
